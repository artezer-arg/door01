...
function App() {
  ...
  return (
    <div style={{ 
      ...
      {/* SIDEBAR NAVIGATION (HMI Control Menu - only shown in supervisor modes) */}
      {viewMode !== 'OPERATIVE' && (
        <nav style={{ 
          width: '80px', 
      ...
      {/* VIEWPORT AREA */}
      <div style={{ flex: 1, height: '100vh', width: viewMode === 'OPERATIVE' ? '100vw' : 'calc(100vw - 112px)', overflow: 'hidden', position: 'relative' }}>
        {viewMode === 'OPERATIVE' && (
          <OperativeView 
